"""
PermissionNotFoundError module.
"""
...
class PermissionNotFoundError(DomainBaseError):
    """
    PermissionNotFoundError class.
    """
    ...
    def __init__(self, *, field: str, value: Any) -> None:
        """
        PermissionNotFoundError constructor.
        ...
        message = f"Permission with <<<{field}>>> <<<{value}>>> was not found."
