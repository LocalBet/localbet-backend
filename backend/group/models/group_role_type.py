...
class Group(DataModel):
    ...
    __group_id: GroupRoleTypeGroupId
    ...
    def __init__(self, id: str | UUID, group_id: str | UUID, name: str, description: str | None, create_date: datetime | str, update_date: datetime | str) -> None:
        self.__id = GroupRoleTypeId(value=id)
        self.__name = GroupRoleTypeName(value=name)
        self.__group_id = GroupRoleTypeGroupId(value=group_id)
    ...
    @property
    def group_id(self):
        # NOTE: Can't be setted to another group
    ...
    def description(self, value: str | None) -> None:
        self.__description = GroupRoleTypeDescription(value=value)
