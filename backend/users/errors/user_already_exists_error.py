...
class UserAlreadyExistsError(DomainBaseError):
    """
    ...
    def __init__(self, *, field: str, value: Any) -> None:
        """
        UserAlreadyExistsError constructor.

        Args:
            field (str): Name of the field that caused the conflict (e.g., 'username' or 'email').
